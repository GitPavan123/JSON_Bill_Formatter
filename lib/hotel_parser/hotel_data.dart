import 'package:json_bill_formatter/constants/image_strings.dart';

class HotelData {
  static final List<Map<String, dynamic>> bananaLeaf = [
    {
  ...
  static final List<Map<String, dynamic>> hotelThalapakatti = [
    {
      'itemName': "Masala Dosa",
      'isVeg': true,
      'amount': "206",
  ...
  static final List<Map<String, dynamic>> gingerWorld = [
    {
      'itemName': "Butter Chicken",
      'isVeg': false,
      'amount': "320",
